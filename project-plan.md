...
| 12 | Deny-Conflict Handling (install.sh detection + mission-time inspection + fleet audit + docs) | Ops | M | 11 | **COMPLETE 2026-05-17** (12-1 Phase 0 Task A settings inspection; 12-2 exact REPLACE/WITH diff; 12-3 extended pattern to [curl,wget,httpie,http]; 12-4 audit-fleet-deny.sh; 12-5 field-manual/permission-conflicts.md; fleet audit found 6/15 workspaces with conflicts; freecalchub still has residual wget deny — user fix decision) |
